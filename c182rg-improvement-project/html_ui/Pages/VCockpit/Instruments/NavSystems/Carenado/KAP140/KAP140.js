class KAP140 extends BaseInstrument {
    ...
    connectedCallback() {
        ...
        SimVar.SetSimVarValue(`L:AP_KAP140_INSTALLED`, "Boolean", true);
    }
    ...
    Update() {
        ...
        var avionicsIsOff = !Number(avionics)
        var batteryIsOff = !Number(masterBattery)
        if (avionicsIsOff || batteryIsOff) {
        ...
        if (this.isElectricityAvailable()) {
            ...
            if((SimVar.GetSimVarValue("Indicated Altitude","feet") - SimVar.GetSimVarValue("Autopilot altitude lock var","feet") > 0)  && (SimVar.GetSimVarValue("AUTOPILOT VERTICAL HOLD VAR","feet/minute") >= 0 ))
            {
                this.MidARM.style.visibility = "hidden";

            } else if ((SimVar.GetSimVarValue("Autopilot altitude lock var","feet") - SimVar.GetSimVarValue("Indicated Altitude","feet")  < 0)  && (SimVar.GetSimVarValue("AUTOPILOT VERTICAL HOLD VAR","feet/minute") <= 0 )) {
                
                this.MidARM.style.visibility = "hidden";                         
            
            } else if ((SimVar.GetSimVarValue("AUTOPILOT MASTER", "Bool") && SimVar.GetSimVarValue("AUTOPILOT VERTICAL HOLD", "Bool")) && (Math.abs(SimVar.GetSimVarValue("Autopilot altitude lock var","feet") - SimVar.GetSimVarValue("Indicated Altitude","feet")) > 1000)) {
            ...
            } else if (differenceToObj >= 200 && differenceToObj <= 1000) {
